...
class movies:
    def __init__(self):
        ...
        self.mix_link = 'http://www.imdb.com/list/ls053143856/?view=detail&sort=title:asc&title_type=feature,short,tv_movie,tv_special,video,documentary,game&start=1'
...
#        self._link = 'http://www.imdb.com/search/title?,desc&count=40&start=1'
    ...
    def genres(self):
        genres = [
            ('[B][COLOR ffff0000]A[/COLOR][COLOR white]CTION[/COLOR][/B]', 'action', True),
            ('[B][COLOR ffff0000]A[/COLOR][COLOR white]DVENTURE[/COLOR][/B]', 'adventure', True),
            ('[B][COLOR ffff0000]A[/COLOR][COLOR white]NIMATION[/COLOR][/B]', 'animation', True),
            ('[B][COLOR ffff0000]A[/COLOR][COLOR white]NIME[/COLOR][/B]', 'anime', False),
            ('[B][COLOR ffff0000]B[/COLOR][COLOR white]IOGRAPHY[/COLOR][/B]', 'biography', True),
            ('[B][COLOR ffff0000]C[/COLOR][COLOR white]OMEDY[/COLOR][/B]', 'comedy', True),
            ('[B][COLOR ffff0000]C[/COLOR][COLOR white]RIME[/COLOR][/B]', 'crime', True),
            ('[B][COLOR ffff0000]D[/COLOR][COLOR white]OCUMENTARY[/COLOR][/B]', 'documentary', True),
            ('[B][COLOR ffff0000]D[/COLOR][COLOR white]RAMA[/COLOR][/B]', 'drama', True),
            ('[B][COLOR ffff0000]F[/COLOR][COLOR white]AMILY[/COLOR][/B]', 'family', True),
            ('[B][COLOR ffff0000]F[/COLOR][COLOR white]ANTASY[/COLOR][/B]', 'fantasy', True),
            ('[B][COLOR ffff0000]H[/COLOR][COLOR white]ISTORY[/COLOR][/B]', 'history', True),
            ('[B][COLOR ffff0000]H[/COLOR][COLOR white]ORROR[/COLOR][/B]', 'horror', True),
            ('[B][COLOR ffff0000]M[/COLOR][COLOR white]USIC[/COLOR][/B]', 'music', True),
            ('[B][COLOR ffff0000]M[/COLOR][COLOR white]USICAL[/COLOR][/B]', 'musical', True),
            ('[B][COLOR ffff0000]M[/COLOR][COLOR white]YSTERY[/COLOR][/B]', 'mystery', True),
            ('[B][COLOR ffff0000]R[/COLOR][COLOR white]OMANCE[/COLOR][/B]', 'romance', True),
            ('[B][COLOR ffff0000]S[/COLOR][COLOR white]CIENCE FICTION[/COLOR][/B]', 'sci_fi', True),
            ('[B][COLOR ffff0000]S[/COLOR][COLOR white]PORT[/COLOR][/B]', 'sport', True),
            ('[B][COLOR ffff0000]T[/COLOR][COLOR white]HRILLER[/COLOR][/B]', 'thriller', True),
            ('[B][COLOR ffff0000]W[/COLOR][COLOR white]AR[/COLOR][/B]', 'war', True),
            ('[B][COLOR ffff0000]W[/COLOR][COLOR white]ESTERN[/COLOR][/B]', 'western', True)
        ]
